...
- Customer profile photos are optional, compressed before saving and editable by the customer or authorised staff. Gender-aware default avatars are used when no photo exists, and the supplied CW mark is used as the browser favicon.
